...
#define field_0_number 4
#define field_1_number 4
...
/* Table structs begin here*/
struct table0 { 
 	struct table_item items [field_4_items];c
} table_0;
struct table1 { 
 	struct table_item items [field_4_items];c
} table_1;
 ...
 *  finish_record(int table)
 struct table2{ 			struct table_item items [field_4_items]; 
 } 			table_4;struct table2{ 			struct table_item items [field_4_items]; 
 } 			table_4;er().
